            ...
            <div className={styles.specialist}>
                <div className={styles.specialistFirst}>
                    ...
                    <div className={styles.specialistInfoWrapper}>
                        <p className={styles.specialistName}>John Black [IT]</p>
                        <p className={styles.specialistDescription}>
                            Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Dolore voluptates repellat hic modi saepe
                            tempore nulla voluptatum nesciunt? Dolorem quos
                            ipsam dolorum deleniti nostrum nisi cupiditate vero
                            minima corrupti! Nihil!
                        </p>
                    </div>
                </div>
                ...
                <div className={styles.specialistSecond}>
                    ...
                    <div className={styles.specialistInfoWrapper}>
                        ...
                        <p className={styles.specialistDescription}>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Officiis atque sit natus repellendus aut iusto
                            placeat, veritatis asperiores voluptatem nemo.
                            Dolorem enim perferendis minima, distinctio quasi at
                            deserunt quae natus. lor
                        </p>
                    </div>
                </div>
            </div>
